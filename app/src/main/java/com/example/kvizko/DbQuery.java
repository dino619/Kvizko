...
import com.example.kvizko.Models.CategoryModel;
import com.example.kvizko.Models.ProfileModel;
import com.example.kvizko.Models.QuestionModel;
import com.example.kvizko.Models.RankModel;
...
public class DbQuery {
    ...
    public static List<CategoryModel> g_catList = new ArrayList<>(); // global category list
    ...
    public static void createUserData(String email, String name, MyCompleteListener completeListener) {
        ...
        userData.put("EMAIL_ID", email);     // key more met isto ime kot stolpec v tabeli od baze
