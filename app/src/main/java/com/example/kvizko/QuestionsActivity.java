...
import static com.example.kvizko.DbQuery.NOT_VISITED;
import static com.example.kvizko.DbQuery.REVIEW;
import static com.example.kvizko.DbQuery.UNANSWERED;
import static com.example.kvizko.DbQuery.g_questList;
import static com.example.kvizko.DbQuery.g_selected_test_index;
import static com.example.kvizko.DbQuery.g_testList;
...
import com.example.kvizko.Adapters.QuestionGridAdapter;
import com.example.kvizko.Adapters.QuestionsAdapter;
...
public class QuestionsActivity extends AppCompatActivity {
    ...
    private AppCompatButton markB, clearSelB;
    ...
    private void init() {
        ...
        questListGV = findViewById(R.id.ques_list_gv);
    ...
    private void submitTest() {
        ...
        AppCompatButton cancelB = view.findViewById(R.id.cancelB);
        AppCompatButton confifmB = view.findViewById(R.id.confirmB);
        ...
        confifmB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timer.cancel();
                alertDialog.dismiss();
